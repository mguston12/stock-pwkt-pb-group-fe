...
const Sekretariat = () => {
  ...
  const GetCustomers = () => {
    setIsLoading(true)
    const url = `http://192.168.88.58:8080/customers?company=${selectedCompany.value}&page=${currentPage}&length=${itemsPerPage}`
  ...
  const SearchCustomer = () => {
    setIsLoading(true)
    const url = `http://192.168.88.58:8080/customers?keyword=${inputSearch}&company=${selectedCompany.value}&page=${currentPage}&length=${itemsPerPage}`
  ...
  function updateCustomer() {
    ...
    var url = `http://192.168.88.58:8080/customers/update`

...
``` bash
# dev server with hot reload at http://192.168.88.250:8080:3000
$ npm start 
```
...
Navigate to [http://192.168.88.250:8080:3000](http://192.168.88.250:8080:3000). The app will automatically reload if you change any of the source files.
